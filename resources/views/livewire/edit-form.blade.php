  ...
  <div class="row">
    ...
    <div class="col-md-8 col-12">
      ...
      <div class="mb-3">
        ...
        <input id="images" wire:model='temporary_images' type="file" name='images' multiple class="d-none form-control shadow @error('temporary_images.*') is-invalid @enderror" >
        ...
        <div class="col-md-8 col-12">
          ...
          <div class="row border border-4 border-white py-4">
            ...
            <div class="col my-3">
              ...
              <button type="button" class="btn btn-danger btn-small d-block text-center mt-2 mx-auto " wire:click="removeImage({{$key}})">Cancella</button>
            </div>
            @endforeach
      ...
      <div class="row vhCustom">
        <div class="col-12 d-flex justify-content-center align-items-center">
          <button class="btn border border-white display-1" onclick="event.preventDefault();document.getElementById('images').click()">
