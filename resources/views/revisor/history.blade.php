                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center borderRevisor">
                                        ...
                                        <h5> <span class="badge bg-danger">{{__('ui.revisionRejected')}}</span></h5>
                                        @elseif($house->is_accepted === 1)
                                        <h5> <span class="badge bg-success">{{__('ui.revisionAccepted')}}</span></h5>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center borderRevisor">
                                        ...
                                        <i class="fa-solid fa-arrow-rotate-left mainColor"></i>{{__('ui.revisionReset')}}</a>
